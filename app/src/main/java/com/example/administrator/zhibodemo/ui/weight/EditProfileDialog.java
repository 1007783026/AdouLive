...
public class EditProfileDialog implements View.OnClickListener {
    ...
    private EditProfileDialog.OnProfileChangedListener mListener;

    public EditProfileDialog(Activity activity, EditProfileDialog.OnProfileChangedListener listener) {
    ...
    public EditProfileDialog(Activity activity, int styleid, EditProfileDialog.OnProfileChangedListener listener) {
        this.activity = activity;
        //把dialog实例化
